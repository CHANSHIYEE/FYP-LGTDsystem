...
public class ReputationController {
    ...
    public ResponseEntity<ReputationMetricsDTO> getReputationMetrics(
        ...
        ReputationMetricsDTO metrics = reputationService.calculateReputationMetrics(companyId, startDate, endDate);
    ...
    public ResponseEntity<List<OrderDTO>> getCompanyOrders(
        ...
        List<OrderDTO> orders = reputationService.getAllOrders(companyId, startDate, endDate);
